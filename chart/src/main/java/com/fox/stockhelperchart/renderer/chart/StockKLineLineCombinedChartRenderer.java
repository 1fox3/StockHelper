...
public class StockKLineLineCombinedChartRenderer extends CombinedChartRenderer {
    public StockKLineLineCombinedChartRenderer(CombinedChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
